...
public class GroupDB {
    ...
    public Group initGroup (){
        ...
        if (members!=null) {
            group.members = gson.fromJson(members, new TypeToken<ArrayList<String>>() {}.getType());
        }
        if  (children != null) {
            group.nodeData.children = gson.fromJson(children, new TypeToken<ArrayList<String>>() {}.getType());
        }
        return group;
    }
}
